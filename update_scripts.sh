...
script_files=(
    ...
    "support/support-glances.sh"
    "support/support-hackingtool.sh"
    "support/support-hashcat.sh"
    "support/support-hcxdump.sh"
    "support/support-hcxdump_dorcascan.sh"
    "support/support-hcxdump_full.sh"
    "support/support-hcxdump-pmkid.sh"
    "support/support-hcxdump.redo.sh"
