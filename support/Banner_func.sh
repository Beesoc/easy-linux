...
printf "${GN}    ${GN}██${BK}╔═══╝ ${GN}▄██${GN}▀▀${GN}██▄${BK}╗ ${GN}██${BK}╔═══╝  ${GN}▀██▄▄██▀${BK}╗   ${GN}██${BK}╔╝   ${GN}██${BK}║   ${GN}██${BK}║ ${GN}██▄${BK}╗ ${GN}██${BK}║ ${GN}██${BK}║  ${GN}██${BK}║     ${GN}▀██▄██▀${BK}╝${GN}    \\n"
printf "${OGG}    ${GN}██████${BK}╗ ${GN}▄█████▄${BK}╗  ${GN}▀███▄${BK}╗    ${GN}▀██▀${BK}╔╝    ${GN}██${BK}║   ${GN}██${BK}║ ${GN}██ ██▄██${BK}║ ${GN}██${BK}║\\n  "
printf "  ${GN}██${BK}║     ${GN}██${BK}║${GN}    ${OGG}     ${GN}██${BK}"
printf "╔══╝    ${GN}██${BK}║  ${GN}██${BK}║   ╚══${GN}██${BK}║   ${GN}██${BK}╔╝       ${GN}██${BK}║  \\n  ${GN}██${BK}║ ${GN}██${BK}║${GN}▀███${BK}║ ${GN}██${BK}║  ${GN}██${BK}║  ${GN}▄██▀██▄${BK}╗  \\n"
printf "  ${WT}${OGG}  ${WT}▀████▀${BK}╝ ${WT}██${BK}║  ${WT}██${BK}║  ${WT}▀███▀${BK}╝    ${WT}██${BK}║      ${WT}▀████${BK}╗ ${WT}██${BK}║ ${WT}██${BK}║  ${WT}██${BK}║  ${WT}▀███▀${BK}╝  ${WT}██▀${BK}╝  ${WT}▀██${BK}╗   ${BK}"
