...
printf " \\n${WT}"
sudo iw $adapter set type monitor
sudo ifconfig $adapter up; sleep 3
...
sudo /usr/bin/hcxpcapngtool -o /opt/backup/root/handshakes/file$date.pcapng /opt/backup/root/handshakes/file$date.pcap
