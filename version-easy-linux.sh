...
declare -A required_versions=(
	...
	["INSTALLv2.sh"]="0.0.3"
	[".shellcheckrc"]="0.0.3"
	["update_scripts.sh"]="0.0.3"
	["support/misc/pwnip.sh"]="0.0.3"
	...
	["support/support-Banner_func.sh"]="0.0.3"
	...
	["support/support-hcxdump.sh"]="0.0.3"
	...
	["support/support-monitor.sh"]="0.0.3"
	["support/support-monDOWN.sh"]="0.0.2"
	["support/support-makeWordlist.sh"]="0.0.3"
	["support/support-nano.sh"]="0.0.3"
	["support/support-netadapter.sh"]="0.0.3"
	["support/support-ohmy.sh"]="0.0.3"
	["support/support-Prompt_func.sh"]="0.0.3"
	["support/support-sysinfo.sh"]="0.0.3"
